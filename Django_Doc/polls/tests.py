...
class QuestionModelTests(TestCase):
    ...
    class QesutionIndexViewTests(TestCase):
        def test_no_question(self):
            """
                If no question exist, an appropiriate message is displayed.
            """
        ...
        def test_future_question(self):
            """
                Question with a pub_date in the future are't displayed 
                on the index page.
            """
        ...
        def test_future_quesiton_and_past_question(self):
            ...
            """
            create_question(quesiton_text = "Past question.", days = -30)
            create_question(question_text = "Future qeustion.", days = 30)
            response = self.client.get(reverse('polls:index'))
            self.assertQuerysetEqual(
                response.context['latest_quesiton_list'],
                ['<Quesiton: Past question.>']
            )
    ...
    class QuestionDetailViewTest(TestCase):
        def test_future_question(self):
            ...
            """
            future_question = create_question(question_test = 'Future question.', days = 5)
        ...
        def test_past_question(self):
            ...
            """
            past_quesiton = create_question(question_text = 'Past Question.', days = -5)
